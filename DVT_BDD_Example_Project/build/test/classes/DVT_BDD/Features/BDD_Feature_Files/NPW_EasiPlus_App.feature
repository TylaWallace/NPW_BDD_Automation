Feature: EasiPlus Quote
  ...
  Scenario Outline: 1- Navigate and Validate EasiPlus Quote
    ...
    Examples: 
      | ValidAge | CoverAmount     | Premium | InvalidAge  | SumPremium | Title  | FirstName    | Surname    | ID              | ContactNo    | Email                           | StreetNo | StreetName    | Suburb  | City        | PostalCode | ParentDependent | DependentFirstName | DependentDOB |
      | "27"     | "R25000"        | "R 80"   | "12"       | "R80"      | "Mrs"  | "Testy-Lee!" | "NpwA'uto" | "2709064800083" | "0711110011" | "TestyLeeIsATest@testemail.com" | "14"     | "Test Street" | "Bronx" | "Cape Town" | "7800"     | "Mother"        | "Mama-Testy!"      | "09/06/1974" |